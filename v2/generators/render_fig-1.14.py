...
c.text(160, 58, "σ₁", bold=True, size=22)
c.text(160, 224, "σ₁", bold=True, size=22)
...
c.text(440, 58, "σ₁", bold=True, size=22)
c.text(440, 232, "σ₁", bold=True, size=22)
c.text(368, 150, "σ₃", bold=True, size=22)
c.text(512, 150, "σ₃", bold=True, size=22)
c.text(512, 238, "σ₁ > σ₃", size=18, color="#555")
...
c.text(700, 58, "σ₁", bold=True, size=22)
c.text(700, 232, "σ₁", bold=True, size=22)
c.text(628, 150, "σ₃", bold=True, size=22)
c.text(772, 150, "σ₃", bold=True, size=22)
c.text(700, 238, "σ₁ > σ₃", size=18, color="#555")
...
# ---------- Mohr diagram (bottom) ----------
c.text(120, 470, "Failure envelopes", bold=True, size=24)
...
# axis ticks/labels
c.text(ox + 1.0*unit, oy + 20, "σ₃", size=20)
c.text(ox + 3.0*unit, oy + 20, "σ₁", size=20)
c.text(ox + 2.0*unit, oy + 20, "σ₃ᵣ", size=20, color=BLUE)
c.text(ox + 6.0*unit, oy + 20, "σ₁ᵣ", size=20, color=BLUE)
c.text(ox + 1.0*unit, oy + 42, "Δσ₃", bold=True, size=19, color=BLUE)
...
c.text(148, 462, "τ", bold=True, size=24)
...
c.save(f"{repo}/v2/source/fig-1.14-soil-strength-reinforcement.svg",
       f"{repo}/v2/export/fig-1.14-soil-strength-reinforcement.png")
