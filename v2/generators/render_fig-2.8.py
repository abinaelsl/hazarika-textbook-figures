...
# ---------- panel titles ----------
c.text(154, 24, "① Loose & saturated sand  (before vibration)", bold=True, size=18)
c.text(450, 24, "② During vibration — grains lose contact", bold=True, size=18)
c.text(746, 24, "③ After vibration — re-settled & densified", bold=True, size=18)
...
c.grains(p3[0]+8, Y1+10, p3[1]-8, Y2-10, n=80, r_min=3.0, r_max=4.5,
...
c.save(f"{repo}/v2/source/fig-2.8-loose-sand-vibration.svg",
       f"{repo}/v2/export/fig-2.8-loose-sand-vibration.png")
